  ...
  <div id="main">
    ...
    <div class="wrapper">
                        ...
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-editor-insert-invitation"></i> Pedidos</a>
                            <div class="collapsible-body">
								...
								if(!isset($_GET['status'])){
									...
									"><a href="orders.php">Todos los Pedidos</a>
                                </li>
								<?php
      ...
      <section id="content">
        ...
        <div class="container">
  <div class="carousel">
    <a class="carousel-item" href="#one!"><img src="images/image1.jpg" alt="Imagen 1"></a>
    <a class="carousel-item" href="#two!"><img src="images/image2.jpg" alt="Imagen 2"></a>
    <a class="carousel-item" href="#three!"><img src="images/image3.jpg" alt="Imagen 3"></a>
  </div>
</div>
        <!--start container-->
        <div class="container">
