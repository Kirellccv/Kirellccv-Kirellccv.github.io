                    ...
                    <form class="formValidate col s12 m12 l6" id="formValidate" method="post" action="confirm-order.php" novalidate="novalidate">
                      <div class="row">
                        <div class="input-field col s12">
							<label for="payment_type">Tipo de PAgo</label><br><br>
							<select id="payment_type" name="payment_type">
									<option value="Wallet" selected>Billetera</option>
									<option value="Cash On Delivery" <?php if(!$verified) echo 'disabled';?>>Dinero o Delivery</option>							
							</select>
                        </div>
                      </div>					
                      <div class="row">
                      ...
                      <div class="row">
                        <div class="input-field col s12">
                          <i class="mdi-action-credit-card prefix"></i>
							...
							<label for="cc_number" class="">Numero de Tarjeta</label>
                      ...
                      <div class="row">
                        <div class="input-field col s12">
                          <i class="mdi-communication-vpn-key prefix"></i>	
							...
							<label for="cvv_number" class="">Numero CVV </label>								
