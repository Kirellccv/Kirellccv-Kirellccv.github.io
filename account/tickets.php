  ...
  <div id="main">
    ...
    <div class="wrapper">
                        ...
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-action-question-answer"></i> Tickets</a>
                            <div class="collapsible-body">
								...
								if(!isset($_GET['status'])){
									...
									"><a href="tickets.php">Todos los Tickets</a>
                                </li>
								<?php
      ...
      <section id="content">
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">Si tiene algún problema, contáctenos abriendo un ticket.</p>
          <div class="divider"></div>
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Abrir Ticket</h4>
              </div>
<div>
                    ...
                    <form class="formValidate" id="formValidate" method="post" action="routers/add-ticket.php" novalidate="novalidate" class="col s12">
                      <div class="row">
                        <div class="input-field col s12">
                          ...
                          <label for="subject" class="">Sujeto</label>
      ...
      <!-- END CONTENT -->
	        ...
	        <!--start container-->
        <div class="container">
          <p class="caption">Lista de tus Tickets</p>
          <div class="divider"></div>
