    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
                    ...
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i> Pedidos</a>
                            <div class="collapsible-body">
                                <ul>
								<li><a href="all-orders.php">Todos los Pedidos</a>
                                </li>
								<?php
                 ...
                 <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-question-answer"></i> Tickets</a>
                            <div class="collapsible-body">
                                <ul>
								<li><a href="all-tickets.php">Todos los Tickets</a>
                                </li>
								<?php
            ...
            <li class="bold active"><a href="users.php" class="waves-effect waves-cyan"><i class="mdi-social-person"></i> Usuarios</a>
            </li>			
        </ul>
      ...
      <section id="content">
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">Habilitar, deshabilitar o verificar usuarios.</p>
...
<table>
                    <thead>
                      <tr>
                        ...
                        <th data-field="price">Deshabilitado</th>
		  ...
		  <form class="formValidate" id="formValidate" method="post" action="routers/add-users.php" novalidate="novalidate">
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Añadir Usuario</h4>
              </div>
              <div>
<table>
                    <thead>
                      <tr>
                        ...
                        <th data-field="price">Rol</th>
                        <th data-field="price">Verificado</th>
                        <th data-field="price">Habilidato</th>		
                      </tr>
                    </thead>
